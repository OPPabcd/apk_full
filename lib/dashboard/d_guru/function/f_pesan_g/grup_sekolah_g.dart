...
import 'package:apk/dashboard/d_guru/function/f_pesan_g/anggota_g/member_sekolah_g.dart';
...
class GrupSekolahG extends StatefulWidget {
  const GrupSekolahG({super.key});

  @override
  State<GrupSekolahG> createState() => _GrupSekolahGState();
}

class _GrupSekolahGState extends State<GrupSekolahG> {
