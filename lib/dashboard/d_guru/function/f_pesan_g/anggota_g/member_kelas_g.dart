...
import 'package:apk/dashboard/d_guru/database/db_murid.dart';

class MemberKelasPageG extends StatefulWidget {
  final String classId;
  const MemberKelasPageG({super.key, required this.classId});

  @override
  State<MemberKelasPageG> createState() => _MemberKelasPageGState();
}

class _MemberKelasPageGState extends State<MemberKelasPageG> {
      ...
      children: [
        ...
        ..._muridsInClass.map((m) {
          ...
          return ListTile(
            ...
            title: Text(name, style: const TextStyle(fontFamily: 'Inter', fontWeight: FontWeight.w500)),
            subtitle: const Text('Murid', style: const TextStyle(fontFamily: 'Inter', fontSize: 13)),
          );
        }).toList(),
      ],
    );
