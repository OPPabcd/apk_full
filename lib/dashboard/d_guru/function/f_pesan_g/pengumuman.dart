...
import 'package:apk/dashboard/d_guru/database/db_pengumuman.dart';
import 'package:apk/dashboard/d_guru/database/storage/doc_pengumuman.dart';
import 'package:apk/dashboard/d_guru/database/db_grup_sekolah.dart';
...
class PengumumanPage extends StatefulWidget {
  ...
  const PengumumanPage({super.key, this.classId});
...
class _PengumumanPageState extends State<PengumumanPage> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      // 4. Send to Grup Sekolah or Grup Kelas
      if (roleInfo != null) {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(widget.classId != null && widget.classId!.isNotEmpty
                ? 'Pengumuman berhasil dikirim ke Grup Kelas'
                : 'Pengumuman berhasil dikirim ke Grup Sekolah'),
          ),
        );
      }
    } catch (e) {
