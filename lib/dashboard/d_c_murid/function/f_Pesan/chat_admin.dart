...
class _ChatAdminPageState extends State<ChatAdminPage> {
  ...
  Future<void> _fetchIdentities() async {
    try {
      ...
      final muridRes = await Supabase.instance.client
          ...
          .eq('nis', nis)
          .single();
      _idMurid = muridRes['id_tabel']?.toString();
      ...
      if (_idMurid != null && _idAdmin != null) {
        _chatStream = _dbPesan.getChatWithAdminStream(_idMurid!, _idAdmin!);
  ...
  Future<void> _sendMessage() async {
    ...
    if (_idMurid == null || _idAdmin == null || _userIdAdmin == null) return;
                          ...
                          builder: (context, snapshot) {
                            ...
                            return ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    final isMe = msg['pengirim_murid'] == _idMurid;
