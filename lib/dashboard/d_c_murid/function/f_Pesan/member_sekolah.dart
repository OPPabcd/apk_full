...
class MemberSekolahPage extends StatefulWidget {
  const MemberSekolahPage({super.key});

  @override
  State<MemberSekolahPage> createState() => _MemberSekolahPageState();
}

class _MemberSekolahPageState extends State<MemberSekolahPage> {
  ...
  Future<void> _loadData() async {
    try {
      final classRes = await DbMurid().getKelas();
      final guruRes = await DbGuru().getAllGuru();
      final muridRes = await DbMurid().getAllMurid();
