...
import 'package:apk/dashboard/a_admin/function/f_pesan/member_sekolah.dart';
import 'package:apk/dashboard/a_admin/function/f_pesan/pengumuman.dart';
...
class _GrupSekolahState extends State<GrupSekolah> {
  ...
  Future<void> _updateLastVisited() async {
    try {
      final prefs = await SharedPreferences.getInstance();
      await prefs.setString('last_visited_grup_sekolah', DateTime.now().toIso8601String());
    } catch (e) {
      debugPrint('Error updating last visited: $e');
    }
  }
