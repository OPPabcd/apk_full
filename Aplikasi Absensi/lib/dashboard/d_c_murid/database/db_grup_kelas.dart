...
class DbGrupKelas {
  ...
  // Hapus pesan grup kelas yang lebih lama dari 24 jam
  static Future<void> deleteExpiredMessages() async {
    try {
      ...
      await supabase.from('grup_kelas').delete().lt('created_at', cutOff);
    } catch (e) {
      if (kDebugMode) print('Clean Group Class Messages Error: $e');
    }
  }
}
