...
import 'package:apk/dashboard/d_c_murid/function/f_Pesan/member_kelas.dart';
...
class GrupKelasPage extends StatefulWidget {
  const GrupKelasPage({super.key});

  @override
  State<GrupKelasPage> createState() => _GrupKelasPageState();
}

class _GrupKelasPageState extends State<GrupKelasPage> {
            ...
            child: Column(
              ...
              children: [
                ...
                if (idIzin.isNotEmpty) ...[
                  const Divider(),
                  IzinStatusWidget(idIzin: idIzin, isTeacher: false),
                ],
                const SizedBox(height: 8),
                Align(
            ...
            onPressed: () {
              if (_currentClassId != null && _currentClassId!.isNotEmpty) {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => MemberKelasPage(classId: _currentClassId!),
                  ),
                );
              } else {
                ScaffoldMessenger.of(context).showSnackBar(
