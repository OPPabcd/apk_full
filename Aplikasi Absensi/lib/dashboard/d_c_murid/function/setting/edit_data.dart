...
class EditDataOrtu extends StatefulWidget {
  ...
  @override
  State<EditDataOrtu> createState() => _EditDataOrtuState();
}

class _EditDataOrtuState extends State<EditDataOrtu> {
  ...
  Widget genderField() {
    return Column(
      ...
      children: [
        ...
        DropdownButtonFormField<String>(
          isExpanded: true,
          initialValue: genderC.text.isEmpty ? null : genderC.text,
          decoration: InputDecoration(
