...
class _PengumumanState extends State<Pengumuman> {
  ...
  String? _loggedInGuruId;
  String? _loggedInClassId;
  String? _adminId;
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      // 1. Dapatkan info guru yang login (sama persis seperti db_kelas)
      ...
      // 3. Ambil guru yang id_class-nya ada di validClassIds (langsung dari DB)
      ...
      // 4. Ambil murid langsung — pola dari db_kelas.getMuridForGuru()
      ...
      // Relasi B: Dari id_murid di tabel class_name
      ...
      debugPrint('Error _loadData pengumuman: $e');
      if (mounted) {
        setState(() => _isLoading = false);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          //     Navigator.push(
          //       context,
          //       MaterialPageRoute(builder: (context) => const PreviewPesan()),
          //     );
          //   },
          // ),
          Padding(
          ...
          : ListView(
              ...
              children: [
                ...
                ...(_listMurid ?? []).map((murid) {
                  ...
                  final classNameObj = murid['class_name'];
                  String kelas = "Belum ada kelas";
                  if (classNameObj != null) {
                    if (classNameObj is String) {
                      kelas = classNameObj;
                        ...
                        return Stack(
                          children: [
                            CustomCard(
                              ...
                              margin: EdgeInsets.zero,
                              onTap: () {
                                ChatPrivateNotification.setSenderUnread(muridId, false);
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => ChatPrivateG(
